...
public class EffectorConstants {
    ...
    public static final double INTAKE_CORAL = 0.25; // Intake power at 40%
    ...
    static {
        ...
        EFFECTOR_CONFIG.CurrentLimits.SupplyCurrentLimitEnable = true;
        EFFECTOR_CONFIG.CurrentLimits.SupplyCurrentLimit = 40;
    }
}