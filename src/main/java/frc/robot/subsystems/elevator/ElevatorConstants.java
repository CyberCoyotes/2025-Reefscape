...
public class ElevatorConstants {
    ...
    // Motion constraints
    public static final double MAX_POSITION = 30.0; // According to initial testing should be 26-30 ish, sorta kinda
    public static final double MIN_POSITION = 0.0;
    public static final double POSITION_TOLERANCE = MAX_POSITION * .05;

    // PID and FF Gains
    public static final class Gains {
        public static final double kP = 1.00;   // 0.80
    ...
    */
    public static final class MotionMagic {
        ...
        /*
        | CRUISE_VELOCITY | ACCELERATION | JERK | Notes |
        ---------------------------------------------------
        | 40              | 40           | 100  | Violent |
        | 20              | 10           | 400  | Violent |
         */
