...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private MotionMagicVoltage motionMagicRequest;
        ...
        private void configureMotors() {
            ...
            leaderConfig.SoftwareLimitSwitch.ForwardSoftLimitThreshold = ElevatorConstants.MAX_HEIGHT * ElevatorConstants.GEAR_RATIO;
            leaderConfig.SoftwareLimitSwitch.ReverseSoftLimitEnable = true;
            leaderConfig.SoftwareLimitSwitch.ReverseSoftLimitThreshold = ElevatorConstants.MIN_HEIGHT * ElevatorConstants.GEAR_RATIO;
        ...
        config.MotionMagic.MotionMagicCruiseVelocity = enabled ? 
            ElevatorConstants.SAFETY_CRUISE_VELOCITY : 
            ElevatorConstants.CRUISE_VELOCITY;
        config.MotionMagic.MotionMagicAcceleration = enabled ? 
            ElevatorConstants.SAFETY_ACCELERATION : 
            ElevatorConstants.ACCELERATION;
        config.MotionMagic.MotionMagicJerk = enabled ? 
            ElevatorConstants.SAFETY_JERK : 
            ElevatorConstants.JERK;
