      ...
      // autoChooser.addRoutine("STJ-L1", autoRoutines::STJL1);
       SmartDashboard.putData("Autonomous", autoChooser);
        ...
        private void configureBindings() {
                ...
                // driverController.rightBumper().whileTrue(endEffector.scoreEffectorTorque());
                ...
                // .whileTrue(new SetEndEffectorCommand(endEffector,
                // EffectorState.INTAKE_ALGAE));
                operatorController.rightBumper();
                // .whileTrue(new SetEndEffectorCommand(endEffector,
                // EffectorState.SCORE_ALGAE));
