 ...
 */
public final class WristCommands_Motor {
    private WristCommands_Motor() {
     ...
     */
    public static Command setPosition(WristSubsystemMotor wrist, double targetRotations) {
    ...
    public static final class Sequences {
        ...
        public static Command loadToSafe(WristSubsystemMotor wrist) {
