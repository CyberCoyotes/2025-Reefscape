 ...
 */
public class AlignToReefLeftWithMaser extends SequentialCommandGroup {
     ...
     */
    public AlignToReefLeftWithMaser(CommandSwerveDrivetrain drivetrain, MaserCannon maserSensor) {
        addCommands(
